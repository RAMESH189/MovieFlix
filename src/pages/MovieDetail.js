  ...
  useEffect(() => {
    async function fetchDetails() {
      const response = await fetch(
        `https://api.themoviedb.org/3/movie/${params.id}?api_key=9bb72c24695b8a5b25f9b8c341f2786f`
      );
    ...
    <main>
      <section className="flex justify-around flex-wrap py-5 ">
        ...
        <div className="max-w-2xl text-gray-700 dark:text-white">
          <h1 className="font-bold text-4xl my-3 text-center lg:text-left">
            {movie.title}
          </h1>
          ...
          <div className="flex items-center py-3">
            <svg
              className="w-4 h-4 text-yellow-500 mr-1 dark:text-yellow-300"
              aria-hidden="true"
            ...
            <span className=" text-gray-900 hover:underline dark:text-white">
